...
struct BrutalRealityReview: Codable, Identifiable {
    ...
    let colorTheme: BrutalRealityColorTheme
...
struct BrutalRealityColorTheme: Codable {
    let primary: String
...
struct BrutalRealityResponse: Codable {
    let success: Bool
    let brutalReality: BrutalRealityReview?
    let generated: Bool?
    let error: String?

    enum CodingKeys: String, CodingKey {
        case success, brutalReality, generated, error
    }
}
