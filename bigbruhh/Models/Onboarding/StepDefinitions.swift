...
let STEP_DEFINITIONS: [StepDefinition] = [
    ...
    StepDefinition(
        ...
        phase: .warningInitiation,
        type: .text,
        prompt: "What name should I call you? \nYour real name or what your friends call you.",
    ...
    StepDefinition(
        ...
        phase: .excuseDiscovery,
        type: .text,
        prompt: "When do you always crack?\n\nWhat situation, time,or trigger makes you fold like paper?",
    ...
    StepDefinition(
        ...
        phase: .patternAwareness,
        type: .text,
        prompt: "How many times have you 'started fresh' this year?\nGive me the number.",
    ...
    StepDefinition(
        ...
        phase: .patternAwareness,
        type: .text,
        prompt: "What time tomorrow will you start?\n\nGive me the exact hour and minute.\nNot 'morning' or 'evening'\nthe ACTUAL time.",
